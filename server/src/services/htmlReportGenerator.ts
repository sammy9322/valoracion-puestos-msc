    ...
    <div class="p-12 relative border-t-8 border-blue-800">
      ...
      <div class="mb-8">
        ...
        <p class="text-sm text-gray-600 leading-relaxed text-justify">
          La valoración técnica se efectuó mediante el Manual de Clases y Metodología de Puntos por Factores oficial de la Municipalidad de San Carlos. Esta metodología pondera seis factores clave acumulando un máximo de 950 puntos: Dificultad de Funciones (150 pts máx.), Supervisión Ejercida (150 pts máx.), Responsabilidad por Activos, Valores y Datos (200 pts máx.), Condiciones de Trabajo (150 pts máx.), Consecuencia de los Errores (150 pts máx.), y Requisitos Formativos y de Experiencia (150 pts máx.). El cálculo se fundamenta en un análisis técnico cruzado de tres fuentes de información: la Ficha Oficial de Puestos, la Entrevista al Ocupante y la inyección transaccional de los Procedimientos Operativos del departamento desde Supabase, garantizando la máxima objetividad, trazabilidad y consistencia jerárquica.
        </p>
      </div>
