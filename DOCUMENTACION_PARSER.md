...
4. **Agente de Reconstrucción de Oraciones (NUEVO):** El motor ahora incluye una lógica heurística que detecta si una línea de texto es una continuación de la anterior. Si una línea no termina en puntuación o la siguiente no cumple con los criterios de "Nueva Función" (viñeta o mayúscula), el agente las une automáticamente, eliminando los saltos de línea artificiales del PDF y creando párrafos coherentes y profesionales.
