        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm">
            ...
            <tbody>
              ...
              {data.cruce.length === 0 && (
                <tr>
                   <td colSpan={5} className="p-8 text-center text-muted-foreground">No hay evaluaciones registradas. Debe evaluar Fichas para que aparezcan en el Cruce Salarial.</td>
                </tr>
              )}
            </tbody>
          </table>
