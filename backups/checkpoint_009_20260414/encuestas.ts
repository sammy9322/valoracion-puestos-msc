...
const FUENTES_OFICIALES = [
  ...
  { id: 'mtss', nombre: 'Ministerio de Trabajo y Seguridad Social', url: 'https://www.mtss.go.cr/web/gaceta/', peso: 0.95 },
  { id: 'dgsc', nombre: 'Dirección General del Servicio Civil', url: 'https://www.dgsc.go.cr/sitio/escales-salariales/', peso: 0.85 },
  { id: 'cgr', nombre: 'Contraloría General de la República', url: 'https://www.cgr.go.cr/articulo/normativa-sobre-escales-de-salarios/', peso: 0.8 },
  { id: 'ungl', nombre: 'Unión Nacional de Gobiernos Locales', url: 'https://www.ungl.or.cr/informacion/municipalidades/', peso: 0.75 },
  { id: 'cj', nombre: 'Colegio de Profesionales', url: 'https://www.cpj.go.cr/tabla-de-salarios/', peso: 0.7 },
  { id: 'ccss', nombre: 'CCSS - Salarios Mínimos', url: 'https://www.ccss.go.cr/empleo/salarios-minimos/', peso: 0.65 },
  { id: 'mh', nombre: 'Ministerio de Hacienda', url: 'https://www.hacienda.go.cr/tesoreria/escales-salariales/', peso: 0.7 },
  { id: 'ine', nombre: 'INEC - Encuesta Nacional de Hogares', url: 'https://www.inec.go.cr/empleo/encuesta-nacional-de-hogares/', peso: 0.8 },
  { id: 'municipal', nombre: 'Federación de Municipalidades', url: 'https://www.cs.go.cr/gestion-municipal/escales-salariales/', peso: 0.75 },
];
